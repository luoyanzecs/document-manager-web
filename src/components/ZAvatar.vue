<template>
  <div class="w-12 h-12 rounded-full bg-gray-300 pos-center relative"
    ...
    <transition-group name="fade">
      <div v-show="isPopOver" :key="1" class="absolute top-0 right-0 h-16 w-12 opacity-0 rounded z-30"/>
      <div v-show="isPopOver" :key="2" @click.stop
