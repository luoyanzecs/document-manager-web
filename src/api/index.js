...
export const FILE_MENU = params => post('user/menu', params)
...
export const NOTICE_GLOBAL = params => post('notice', params)
export const GET_FILE = params => post('user/file', params)